...
public class Constants {
    ...
    public static String URL_RELEASE_LATEST = "https://api.github.com/repos/lambda567/AListLiteAndroid-Plus/releases/latest";
    public static String URL_RELEASES = "https://api.github.com/repos/lambda567/AListLiteAndroid-Plus/releases";
    public static String URL_OPEN_ISSUE = "https://github.com/lambda567/AListLiteAndroid-Plus/issues";
    public static String URL_OPEN_DISCUSSION = "https://github.com/lambda567/AListLiteAndroid-Plus/discussions";
    ...
    public static String QUICK_DOWNLOAD_ADDRESS = "https://gitee.com/lambda567/AListLiteAndroid-Plus/releases/download";
